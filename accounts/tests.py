...
#         response = self.client.post('/auth/jwt/create/', date={'username': 'mario', 'password': 'i-keep-jumping'})
...
#         """Проверка, что получаем данные профиля аутентифицированного пользователя"""
